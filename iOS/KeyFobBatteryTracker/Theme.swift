...
/// Unique palette for Key Fob Battery Tracker.
enum FobTheme {
    static let accent = Color(hex: "#3E7CB1")
    static let background = Color(hex: "#0E1F2E")
    static let card = Color(hex: "#0E1F2E").opacity(0.55)
